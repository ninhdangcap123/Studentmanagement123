						    ...
						    <div class="dataTable_wrapper">
							    <table class="table table-striped table-bordered table-hover" id="dataTables-example">
								    ...
								    <tbody>
									    ...
									    <td>&nbsp;&nbsp;<a href="index.php?Controller=Course&action=edit-course&cid=<?php echo htmlentities($res->cid);?>"><p class="fa fa-edit"></p></a> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
									    <a href="index.php?Controller=Course&action=view-course&del=<?php echo htmlentities($res->cid); ?>"> <p class="fa fa-times-circle"></p></td>
									    </tr>
									    <?php $sn++;
										  }?>
								    </tbody>
