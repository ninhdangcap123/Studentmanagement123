							    ...
							    <table class="table table-striped table-bordered table-hover" id="dataTables-example">
								    ...
								    <tbody>
									    ...
									    <tr class="odd gradeX">
										    ...
										    <td>&nbsp;&nbsp;<a href="index.php?Controller=Subject&action=edit-sub&sid=<?php echo htmlentities($res->subid);?>"><p class="fa fa-edit"></p></a> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
										    <a href="index.php?Controller=Subject&action=view-subject&del=<?php echo htmlentities($res->subid); ?>"> <p class="fa fa-times-circle"></p></td>
									    </tr>
									    <?php $sn++;
										  }?>
								    </tbody>
