								    ...
								    <table class="table table-striped table-bordered table-hover" id="dataTables-example">
									    ...
									    <tbody>
										    ...
										    <tr class="odd gradeX">
											    ...
											    <td>&nbsp;&nbsp;<a href="index.php?Controller=Student&action=edit-std&id=<?php echo htmlentities($res->id);?>">
													  <p class="fa fa-edit"></p></a> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
												    <a href="index.php?Controller=Student&action=view&del=<?php echo htmlentities($res->id); ?>">
